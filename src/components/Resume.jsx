...
import { Download, Eye, Briefcase, GraduationCap, Calendar, Award } from "lucide-react";
  ...
  const experiences = [
    {
      ...
      period: "2023 — Present",
      description: "Architecting high-performance web applications including real-time note taking tools, visual expense trackers, and airline search engines using MongoDB, Express, React, and Node.js."
    },
    {
      role: "Web Application Developer Intern",
      company: "Tech Solutions India",
      period: "2022 — 2023",
      description: "Collaborated on state management architectures using Redux, developed rest endpoints, optimized database queries, and implemented responsive layout wireframes with Tailwind CSS."
    }
  ];
            ...
            <div className="relative border-l border-white/10 pl-6 sm:pl-8 ml-5 space-y-12">
              {experiences.map((exp, index) => (
                <div key={index} className="relative group">
                  ...
                  <p className="text-xs font-mono text-gray-500 mb-4">{exp.company}</p>
